...
const BookingRequest = (props) => {
   ...
   const acceptedbooking = (id, bookingid) => {
      dispatch(sendBookingAccept({ announcementId: id, bookingId: bookingid }))
   }
   const rejectbooking = (id, bookingid) => {
      dispatch(sendBookingReject({ announcementId: id, bookingId: bookingid }))
   }
   return (
      <Container>
         {props.data?.map((el) => {
                        ...
                        {el.status === 'NEW' ? (
                           <div>
                              <Button
                                 variant="contained"
                                 onClick={() =>
                                    rejectbooking(props.id, el.bookingId)
                                 }
                              >
                                 REJECT
                              </Button>
                              <Button
                                 onClick={() =>
                                    acceptedbooking(props.id, el.bookingId)
                                 }
                              >
                                 ACCEPT
                              </Button>
