...
function MyAnnouncment2(props) {
   ...
   const deleteUserAnnouncementHandler = () => {
      dispatch(deleteUserAnnouncement(id))
   }
   ...
   console.log(props.data, 'announcement')
      ...
      <Announcement>
         ...
         {data?.map((el) => {
            return (
               <StyledUserProfile
                  key={el.id}
                  onClick={() => navigate(`/main/detailcard/${el.id}`)}
               >
                  <UserProfileAnnouncementCard
                     ...
                     onEdit={() => {
                        setModal(false)
                        navigate(`/main/editanouncement=${el.id}`)
                     }}
                  />
               </StyledUserProfile>
            )
